...
//Description:                                                                          integer multiplication program


define(Multiplier, w21)                                                                 //represents the multiplier variable
...
main:           stp     x29, x30, [sp, -16]!                                            //stores frame pointer fp and lr
                ...
                mov     Multiplicand, #522133279                                        //intializes the multiplicand to 522133279
                mov     Multiplier, #200                                                //intializes the multiplier to 200
